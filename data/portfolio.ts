...
export const experience: ExperienceItem[] = [
  {
    ...
    impact: [
      "Architected and delivered Holman's flagship Power BI solution, consolidating fragmented 20+ consulting reports into a unified semantic-model-driven platform now used by 1,000+ employees enterprise-wide — establishing the standard for self-service analytics across the organization.",
      "Owned and built out the gold layer of Holman's medallion architecture, delivering 50+ dbt models with incremental load patterns across 10 business domains — creating the enterprise's authoritative single source of truth for analytics consumption.",
      "Unified 8 siloed call-center data sources into a single automated reporting model, eliminating manual Excel workflows and saving 2,000+ hours annually; engineered a PO complexity scoring framework that classified call types by handling complexity, reducing average speed of answer by 15 seconds and surfacing agent performance patterns for operational coaching.",
      "Designed a KPI benchmarking platform that normalized 20 performance metrics across clients, enabling peer-group and industry-level comparison views that equipped Account Managers with data-driven narratives to strengthen client relationships and support retention outcomes.",
      ...
      "Built reusable dbt macros and Azure Databricks SQL transformation layers that feed production-grade star-schema semantic models, enabling consistent, scalable data structures for enterprise Power BI reporting across multiple business domains.",
      "Implemented Git-based Power BI deployment workflows using PBIR artifacts and CI/CD pipelines — introducing source-controlled, environment-gated releases that standardized the BI delivery lifecycle and significantly reduced deployment risk across the enterprise.",
      "Collaborated with Account Managers, Fleet Managers, and IT leaders to translate ambiguous business requirements into production analytics solutions; delivered executive-level analysis on auto-approval rejection patterns and service behavior that gave VP-level stakeholders actionable visibility into workforce training and operational improvement opportunities.",
      "Represented Holman at IBIS 2024 (Phoenix) and led internal knowledge-sharing sessions, consistently communicating complex analytical and design decisions as clear business value narratives to mixed technical and executive audiences.",
    ],
