...
export const experience: ExperienceItem[] = [
  {
    ...
    impact: [
      ...
      "Implemented Git-based Power BI deployment workflows using PBIR artifacts, TMDL files, CI/CD pipelines, GitHub Copilot, and Power BI MCP Server to streamline model development, documentation, and enterprise BI deployments.",
