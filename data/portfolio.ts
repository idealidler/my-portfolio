...
export const experience: ExperienceItem[] = [
  {
    ...
    impact: [
      ...
      "Unified 8 siloed call-center data sources into a single automated reporting model, eliminating manual Excel workflows and saving 200+ hours annually; engineered a PO complexity scoring framework that classified call types by complexity, reducing average speed of answer by 15 seconds and surfacing agent performance patterns for operational coaching.",
      ...
      "Represented Holman at IBIS 2024 and led internal knowledge-sharing sessions, consistently communicating complex analytical and design decisions as clear business value narratives to mixed technical and executive audiences.",
    ],
