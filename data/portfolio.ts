...
export const experience: ExperienceItem[] = [
  {
    ...
    impact: [
      ...
      "Took ownership of the gold layer in Holman's medallion architecture, designing 50+ dbt models, including incremental loads, across 10 business domains to give analytics users a trusted single source of truth.",
      ...
      "Designed reusable dbt macros and Azure Databricks SQL transformations that powered star-schema semantic models for enterprise Power BI reporting.",
