...
const RecruiterFriendly = ({ switchVersion }) => {
  return (
    <motion.section
    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 border-b border-gray-300 pb-6">
        <div>
          ...
          <p className="mt-4 text-gray-700 leading-relaxed max-w-xl">
            ...
            actionable insights, and quickly adapting to new tools and technologies. I am proficient in Power BI,
            SQL, and Python, with strong experience in building pipelines in Microsoft Fabric. I am skilled at
            scoping and planning projects with accurate time estimates, working efficiently in Agile environments,
            and collaborating with business teams to deliver solutions that not only meet requirements but also
            provide additional value through data-driven recommendations.
          </p>
        </div>
        <div className="flex flex-col items-start md:items-end text-gray-600 text-sm space-y-1">
          <div className="flex items-center gap-2">
            <Phone size={16} /> +1 (445) 208-1735
          </div>
          <div className="flex items-center gap-2">
            <Mail size={16} />
            <a
      ...
      <div>
        <h2 className="text-xl font-bold flex items-center gap-2 text-indigo-700">
          <UserCheck size={20} /> Work Authorization & Availability
        </h2>
      ...
      <div>
        <h2 className="text-xl font-bold flex items-center gap-2 text-indigo-700">
          <Clock size={20} /> Experience & Skills
        </h2>
        <p className="mt-2 text-gray-700">
          2+ years of experience building data-driven analytics solutions
        </p>
        <div className="flex flex-wrap gap-2 mt-4">
          {["Python", "SQL", "Microsoft Fabric", "Power BI", "Git CI/CD", "JavaScript / React"].map(
            (skill) => (
              <span
                key={skill}
      ...
      <div>
        <h2 className="text-xl font-bold flex items-center gap-2 text-indigo-700">
          <Briefcase size={20} /> Recent Roles
        </h2>
      ...
      <div>
        ...
        <div className="mt-2 space-y-1 text-gray-700">
          <p>
            <span className="font-medium">Master’s in Business Analytics</span> — Drexel University (2023)
          </p>
          <p>
            <span className="font-medium">Bachelor’s in Electronics and Telecommunications</span> — Pune University (2020)
          </p>
        </div>
      </div>
  ...
  >
    View Hiring Manager Version
      ...
      <footer className="w-full text-center py-6 text-gray-400 text-sm">
        &copy; {new Date().getFullYear()} Akshay Jain. Built with ChatGPT and Copilot with absolute zero web
